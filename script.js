...
const birthdayConfig = {
    ...
    gallery: [
        { image: "photo1.jpg", caption: "Where the chaos began ✨", layout: "grid-feat" },
        { image: "photo2.jpg", caption: "Spontaneous road trips 🚗", layout: "grid-tall" },
        { image: "photo3.jpg", caption: "Late night coffee runs ☕", layout: "grid-std" },
        { image: "photo4.jpg", caption: "Polaroid moments 📸", layout: "grid-polaroid" },
        { image: "photo5.jpg", caption: "Unfiltered laughter 😂", layout: "grid-std" },
        { image: "photo6.jpg", caption: "Golden hour views 🌅", layout: "grid-wide" },
        { image: "photo7.jpg", caption: "Concert nights 🎶", layout: "grid-polaroid" },
        { image: "photo8.jpg", caption: "Core memory unlocked 🔓", layout: "grid-std" },
        { image: "photo9.jpg", caption: "Always laughing 💛", layout: "grid-std" },
        { image: "photo10.jpg", caption: "To many more years 🥂", layout: "grid-wide" }
    ],
    ...
    remember: [
        ...
        { title: "The secret spot", text: "A secret spot, countless talks, and memories no one else knows about!" },
        { title: "First roadtrip", text: "From road trips to green bus rides, every little journey with you turned into a core memory!" },
        { title: "The bad idea", text: "One of our wrost ideas... somehow became one of our best memories." }
    ],

    // Scene 6: Friendship Timeline
    timeline: [
        { date: "Chapter 1", title: "The Beginning", text: "It all started with a simple friendship.... And somehow, you became one of the most special person of my life. Looking back , I'm so glad our paths crossed.", image: "photo1.jpg" },
        { date: "Chapter 2", title: "Our First Adventure", text: "Our little road-trip adventures From cafes to Parks, sharing food & ice-cream .... Every moment with you turned into a beautiful memory. Here's to many more adventures together!", image: "photo6.jpg" },
        { date: "Chapter 3", title: "The Random Chaos", text: "From random plans to complete chaos, we somehow made every moment unforgettable.", image: "photo3.jpg" },
        { date: "Today", title: "Your Birthday 🎂", text: "Celebrating you and another beautiful year of your journey.", image: "hero.jpg" }
    ],
